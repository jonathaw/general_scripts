...
class Blast:
    ...
    def __init__(self, infile_name, infile_path, evalue, min_id, max_targets, coverage, pairwise_file = 'No_file'):
        """
        :param infile_name: file name for query fasta
        :param infile_path: file path
        :param evalue: evalue for BLASt
        :param min_id: minimium identity for after BLAST
        :param max_targets: max targets from BLAST
        :param coverage: frqction cover of query by hit
        :param pairwise_file: NA
        :return:
        """
